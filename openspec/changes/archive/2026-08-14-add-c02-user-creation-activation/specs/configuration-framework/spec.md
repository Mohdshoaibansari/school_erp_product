# configuration-framework — Delta Spec (C-02 User Creation & Activation)

> **Change:** `add-c02-user-creation-activation`
> **Domain:** C-08 Configuration Framework
> **Delta type:** ADDED (new config key; existing domain has prior OpenSpec spec at `openspec/specs/configuration/spec.md`)
> **Source ADR:** `docs/architecture/adr-c02-identity-user-management-implementation.md` D3
