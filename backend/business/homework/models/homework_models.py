...
class Homework(Base):
    ...
    subject_id = Column(UUID(as_uuid=True), ForeignKey("subject.id"), nullable=True)
    grade_level_id = Column(UUID(as_uuid=True), ForeignKey("grade_level.id"), nullable=True)
