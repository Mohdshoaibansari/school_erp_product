...
| C-06 Relationship Management | `docs/prd/C-06-Relationship-Management-Framework-PRD.md` | **Archived** (migration 026 applied; 11 relationship tables + symmetric/inverse support) | — |
| C-13 Address & Location Management | `docs/prd/C-13-Address-Management-PRD.md` | **Implementing** `fix-c13-address-gaps` (G-01..G-19 hardening; migrations 027/028; G-13/G-16 verified, G-15 integration tests, G-19 docs synced) | Verify → archive |
...
| Student & Employee Domain Model | `docs/architecture/adr-student-employee-domain-implementation.md` (v1.1) | Decisions final (D1–D13, grill #1). D3/D6 amended by the identity person-model revamp ADR | Feed to sdd-stack (Phase 2) *after* the identity revamp; C-06 archived, C-13 implementing |
