...
| C-05 Academic Structure | `docs/architecture/adr-c05-academic-structure-implementation.md` | Implemented (42/42 tasks); ready for verify + archive | Verify + Archive |
