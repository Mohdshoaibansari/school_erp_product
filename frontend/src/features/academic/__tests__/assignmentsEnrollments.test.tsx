  ...
  it('lists, enrolls from roster, and removes enrollments', async () => {
    ...
    server.use(
      ...
      http.get('/api/v1/users', () =>
        HttpResponse.json([
          makeUser({ id: 'u2', email: 'student@school.test', name: 'Ben Learner', user_category_id: 'uc1' }),
          makeUser({ id: 'u3', email: 'student2@school.test', name: 'Cara Learner', user_category_id: 'uc1' }),
        ]),
      ),
