...
- [x] 1.1 Define Prisma model: audit_logs (append-only)
- [x] 1.2 Implement AuditService: log, query with filters
...
- [x] 2.2 Implement NotificationService: send with template rendering + email delivery
...
- [x] 3.2 Implement CommunicationService: sendMessage, getConversation, getMessages
- [x] 3.3 Scope messaging to teacher-parent within an institution
