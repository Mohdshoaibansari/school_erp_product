...
**Save token:**
```bash
export TOKEN="eyJhbGciOiJFUzI1NiIsImtpZCI6IjQyZjhkOWQxLWMwZGEtNDliNi04ODBlLTE4MjhkZTFlMDA2NyIsInR5cCI6IkpXVCJ9..R8og7z9bNfVngBMwlxpVgE41JuIzCg307NwYh0LlQ7zqsj8d4Bcw0OFnpYAJ-iep83QfxnPcxIqFwBtuUi46vA"
```
...
**Save institution ID:**
```bash
export INST_ID="566b3c0e-ac58-4a67-a6f3-12b5d0310a4e"
```
...
```bash
curl -X POST $BASE_URL/api/v1/users -H "Authorization: Bearer $TOKEN" -H "Host: $HOST" -H "Content-Type: application/json" -d '{"email":"admin@myschool.com","name":"Institute Admin","user_category_id":"20a3b37b-56be-4573-a7ee-b2c5b016fc24","institution_id":"'$INST_ID'"}' | python -m json.tool
```
