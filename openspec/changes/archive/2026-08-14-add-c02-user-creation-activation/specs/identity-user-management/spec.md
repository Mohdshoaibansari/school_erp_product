# identity-user-management — Delta Spec (C-02 User Creation & Activation)

> **Change:** `add-c02-user-creation-activation`
> **Domain:** C-02 Identity & User Management
> **Delta type:** ADDED (no prior OpenSpec spec exists for this domain)
> **Source ADR:** `docs/architecture/adr-c02-identity-user-management-implementation.md` D1, D2, D3
